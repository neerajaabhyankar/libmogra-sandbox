...
def download_files_for_collection(collection_name, collection_ids, features, startFiles=0, endFiles=5):
...
missingDatas = {}
missingData = download_files_for_collection('data-dunya-hindustani', ['6adc54c6-6605-4e57-8230-b85f1de5be2b'], features_dunya_all, 0, 108)
